<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" stripe fit highlight-current-row style="width: 100%"
      ...
      <el-table-column label="等级产品名称" min-width="110" prop="multiple_name" />
      <el-table-column label="金额" prop="price" min-width="90">
        <template slot-scope="scope">
          {{ formatNum(scope.row.amount) }}
        </template>
      </el-table-column>
     
      <el-table-column label="提交时间" width="140" prop="create_time" />
